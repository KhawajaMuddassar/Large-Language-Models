...
class get_gpt:
    ...
    def download_and_load_gpt(
        self,
        choose_model,
        models_dir='SentimentClassifier/model/model_weights'
        ):        
        model_size = ""
        model_names = {
        "gpt2-small" : "124M" ,         
...
if __name__ == "__main__":
    model_input = str(input('Choose Model size (gpt2-small, gpt2-medium, gpt2-large, gpt2-xl):'))
    get_gpt().download_and_load_gpt(model_input)